					...
					<li class="header-nav-brand" >
						<div class="brand-holder">
							<a href="../../html/dashboards/dashboard.html">
								<span class="text-lg text-bold text-biz"><i class="fa fa-cube fa-fw"></i>VinaOutsource Database</span>
							</a>
						</div>
					</li>
					<li>
					...
					<li class="dropdown">
						<a href="javascript:void(0);" class="dropdown-toggle ink-reaction" data-toggle="dropdown">
							...
							<span class="profile-info">
								<small><?php echo UCFIRST($fn); ?></small>
							</span>
						</a>
						<ul class="dropdown-menu animation-dock">
							<li><a href="../pscripts/logout"><i class="fa fa-fw fa-power-off text-danger"></i> Logout</a></li>
						</ul><!--end .dropdown-menu -->
					</li><!--end .dropdown -->
